"""
ProjectSpecification Generator Stage — assembles a validated ProjectSpecification from the existing context.

This stage does NOT use an LLM. It aggregates the Idea, Requirements, and PRD
and saves them as a unified project_specification.json artifact.
"""
...
class ProjectSpecificationGeneratorStage(Stage):
    """Stage that assembles a validated ProjectSpecification from preceding outputs."""
    ...
    def execute(self, context: ProjectContext) -> ProjectContext:
        ...
        Args:
            context: Current ProjectContext with idea, requirements, and prd populated.

        Returns:
            Updated ProjectContext with project_specification set.
        """
